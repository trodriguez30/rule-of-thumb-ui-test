...
import mediumHeader from "../../../assets/img/pope-francis.png";
import largeHeader from "../../../assets/img/pope-francis.@2x.png";
  ...
  return (
    <header className="hero">
      <img
        ...
        srcSet={`${mediumHeader} 750w, ${largeHeader} 1440w`}
      ...
      <div className="max-centered">
        <div className="hero__featured-card">
          <div className="hero__featured-card--glass-background"></div>
          <div className="hero__featured-card-content">
            <p className="hero__featured-card-content--hairline">
              What's your opinion on
            </p>
            <h2 className="hero__featured-card-content--title">
              Pope Francis?
            </h2>
            <p className="hero__featured-card-content--desc">
            ...
            <p className="hero__featured-card-content--more-info">
            ...
            <p className="hero__featured-card-content--cta">
              What’s Your Veredict?
            </p>
            <div className="hero__featured-card-content--buttons">
      ...
      <div className="hero__closing-gauge">
        <div className="hero__closing-gauge--left">
          <span className="hero__closing-gauge--left-title">closing in</span>
        </div>
        <div className="hero__closing-gauge--right">
          <span className="hero__closing-gauge--right-number">22</span>
          <span className="hero__closing-gauge--right-desc">days</span>
        </div>
      </div>
    </header>
  );
